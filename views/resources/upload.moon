			...
			div class: "card", ->
				...
				div class: "card-block", ->
					fieldset class: "form-group", ->
						...
						input type: "text", class: "form-control", id: "resName", name: "resName", required: true
					...
					fieldset class: "form-group", ->
						...
						textarea class: "form-control", id: "resDescription", name: "resDescription", rows: 3, required: true
			
				div class: "card-footer form-inline", ->
					input type: "file", name: "resource_package", required: true
